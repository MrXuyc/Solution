...
public class Java8Tester {
    public static void main(String[] args) {
        ...
        Arrays.sort((String[]) names1.toArray(), (a, b) -> a.compareTo(b));

        Arrays.sort((String[]) names1.toArray(), (String a, String b) -> {
            return a.compareTo(b);
        });
        Arrays.sort((String[]) names1.toArray(), String::compareTo);
